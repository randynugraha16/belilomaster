  ...
  <div class="container-fluid">
    ...
    <div class="dashboard-content">
        <div class="border border-secondary p-2">
          ...
          <ul>
              <li>Tahun Pajak = <?php echo e(date("Y")); ?></li>
              <li>Bulan Penjualan = <?php echo e(date("M")); ?></li>
          </ul>
        </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\belilo\resources\views/pages/dashboard-omzet.blade.php ENDPATH**/ ?>