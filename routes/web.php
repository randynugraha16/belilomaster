...
Route::get('/toko/{id}', [App\Http\Controllers\HomeController::class, 'toko'])->name('toko');
...
Route::get('/rajaongkir/provinsi', [App\Http\Controllers\Api\LocationController::class, 'RajaOngkirProvinsi'])->name('rajaongkir-provinsi');

Route::middleware(['auth', 'verified'])->group(function () {
    
    Route::get('/cart', [App\Http\Controllers\CartController::class, 'index'])->name('cart');
    Route::get('/cart/cekongkir', [App\Http\Controllers\CartController::class, 'cekongkir'])->name('cekongkir');
    ...
    Route::post('/dashboard/products/delete/{id}', [App\Http\Controllers\DashboardProductController::class, 'delete'])->name('dashboard-product-delete');
    ...
    Route::get('/dashboard/omzet', [App\Http\Controllers\DashboardOmzet::class, 'index'])->name('dashboard-omzet');
    ...
    Route::post('/dashboard/transactions/review/{id}', [App\Http\Controllers\DashboardTransactionController::class, 'review'])->name('dashboard-transactions-review');
