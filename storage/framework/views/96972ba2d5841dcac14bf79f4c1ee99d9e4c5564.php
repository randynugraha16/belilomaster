    ...
    <div class="container">
      ...
      <form action="<?php echo e(route('cekongkir')); ?>" enctype="multipart/form-data" id="locations">
        ...
        <input type="hidden" name="total_price" value="<?php echo e($totalPrice); ?>">
          ...
          <div class="row  d-flex justify-content-center" data-aos="fade-up" data-aos-delay="250">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1358072/public_html/laravel/resources/views/pages/cart.blade.php ENDPATH**/ ?>