            ...
            <div class="row">
                ...
                <div class="col-10 col-md-10 col-lg-3 bg-light p-2 ">
                    ...
                    <h6 class="text-secondary font-weight-light">
                        ...
                        <?php echo e($product->user->created_at->format('m-Y')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bwastore-laravel\resources\views/pages/detail.blade.php ENDPATH**/ ?>