                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="price" value="<?php echo e($product->price); ?>" class="form-control" id="uang" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bwastore-laravel\resources\views/pages/dashboard-products-details.blade.php ENDPATH**/ ?>