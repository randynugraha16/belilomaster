        ...
        <div class="container mt-2">
          <div class="row">
            ...
            <?php
              $totalPrice = $r['total']
            ?>
            <form action="<?php echo e(route('checkout')); ?>" method="POST" class="mt-2">
              <?php echo csrf_field(); ?>
              <input type="hidden" name="total_price" value="<?php echo e($totalPrice); ?>">
              <input type="hidden" name="ongkir" value="<?php echo e($r['biaya']); ?>">
                ...
                <div class="card" style="width: 18rem;">
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6 mb-2">
                        <p class="card-text">Rp. <?php echo e(number_format($total_price, '0', ',', '.')); ?></p>
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\belilo\resources\views/pages/cekongkir.blade.php ENDPATH**/ ?>