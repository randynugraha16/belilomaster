                      ...
                      <h5 class="card-title bg-light p-3">Tentang Produk</h5>
                          <table>
                              ...
                              <tr>
                                ...
                                <?php if($total_rating == NULL): ?>
                                <td class="align-text-bottom">Belum ada pembelian</td>
                                <?php else: ?>
                                
                                <td class="align-text-bottom"><?php echo e($total_rating/$total_review); ?> dari 5  <i class="bi bi-star-fill" style="color: #fd4"></td>
                                <?php endif; ?>
                              </tr>
                          </table>
                      </div>
            ...
            <div class="row">
              <div class="col-lg-8 col-md-8 col-12 p-0 mt-2">
                  <div class="card p-0">
                      <div class="card-body">
                          <h5 class="card-title bg-light p-3">
                              Ulasan Produk (<?php echo e($total_review); ?>)
                          </h5>
                          <div class="card-title py-2 px-5">
                             <?php $__currentLoopData = $review; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reviews): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if(!($reviews->review == NULL)): ?>
                              <div class="media border-bottom mb-4">
                               <img 
                                src="/images/testi/icons-testimonial-<?php echo e(mt_rand(1, 4)); ?>.png" 
                                class="mr-3" 
                                alt="..."
                              >
                              <div class="media-body">
                                <div class="row">
                                  <div class="col-12">
                                    <h5 class="mt-0 text-capitalize"><?php echo e($reviews->user->name); ?></h5>
                                  </div>
                                  <div class="col-12">
                                    <div class="media-star mt-0">
                                      <div class="star-review">
                                                <input type="radio" id="rate-5" <?php echo e($reviews->stars == 5 || $reviews->stars == NULL ? 'checked' : ''); ?>>
                                                <label for="rate-5"> <i class="bi bi-star-fill"></i></label>

                                                <input type="radio" id="rate-4" <?php echo e($reviews->stars == 4 || $reviews->stars == NULL ? 'checked' : ''); ?>>
                                                <label for="rate-4"><i class="bi bi-star-fill"></i></label>

                                                <input type="radio" id="rate-3" <?php echo e($reviews->stars == 3 || $reviews->stars == NULL ? 'checked' : ''); ?>>
                                                <label for="rate-3"><i class="bi bi-star-fill"></i></label>

                                                <input type="radio" id="rate-2" <?php echo e($reviews->stars == 2 || $reviews->stars == NULL ? 'checked' : ''); ?>>
                                                <label for="rate-2"><i class="bi bi-star-fill"></i></label>

                                                <input type="radio" id="rate-1" <?php echo e($reviews->stars == 1 || $reviews->stars == NULL ? 'checked' : ''); ?>>
                                    ...
                                    <?php if(!($reviews->photo == NULL )): ?>
                                    <div class="col-12">
                                      <img
                                        src="<?php echo e(Storage::url($reviews->photo)); ?>"
                                        alt=""
                                        class="<?php echo e((!($reviews->photo == NULL ) ? 'border mb-4' : '')); ?> "
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\belilo\resources\views/pages/detail.blade.php ENDPATH**/ ?>